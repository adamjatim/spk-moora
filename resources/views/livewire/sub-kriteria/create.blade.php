        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="flex items-center">
                    ...
                    <!-- Tombol Tanda Tanya -->
                    <button type="button" id="openModalButton" class="ml-2 text-gray-500 hover:text-gray-700">
            ...
            @if ($parameter_type === 'string')
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Contoh: Masukkan nilai teks/kategorikal seperti "SMA, SMK,
                        D3,
                        S1".</p>
                </div>
            @elseif ($parameter_type === 'nominal')
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Contoh: Masukkan nilai angka tunggal seperti "1, 2, 3, 4".
                    </p>
                </div>
            @elseif($parameter_type === 'range')
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="parameter_max" wire:model="parameter_max" type="text"
                        class="mt-1 block w-full" placeholder="Contoh: 25" />
                    <x-jet-input-error for="parameter_max" class="mt-2" />
                    <p class="text-sm text-gray-500 mt-1">Contoh: Masukkan rentang nilai seperti Minimum "18" dan
                        Maksimum "25".</p>
                </div>
            @endif
