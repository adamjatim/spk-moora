    ...
    <x-jet-form-section submit="update">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input id="tahun_daftar" wire:model="tahun_daftar" type="number" class="mt-1 block w-full"
                    placeholder="kosongkan jika data baru" />
